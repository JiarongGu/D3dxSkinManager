...
/// </summary>
public class SettingFileServiceTests : IDisposable
{
    ...
    public SettingFileServiceTests()
    {
        ...
        _service = new SettingFileService(_mockGlobalPathService.Object, _mockLogger.Object);
