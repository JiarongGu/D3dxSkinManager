...
| `profile` | ProfileManager (list + create/edit/delete + settings export/per-row + import), **ProfileImportDialog** (bundle analyze-preview + work-mode picker — `profile-settings-bundle.md`), ProfileSwitcher |
