...
**Last Updated:** 2026-02-20 (v2.3 - Migration Architecture + Archive Storage Fix)
...
> **Architecture:** Step-based migration from Python d3dxSkinManage to React version
> **Key Update:** Archives now stored WITHOUT extensions (matches Python format)

#### Migration Service (Orchestrator)

- **IMigrationService** → `D3dxSkinManager/Modules/Migration/Services/MigrationService.cs:18`
- **MigrationService** → `D3dxSkinManager/Modules/Migration/Services/MigrationService.cs:44`
...
- **IMigrationStep** → `D3dxSkinManager/Modules/Migration/Steps/IMigrationStep.cs:5`
- **MigrationStep1AnalyzeSource** → `D3dxSkinManager/Modules/Migration/Steps/MigrationStep1AnalyzeSource.cs:18`
- **MigrationStep2MigrateConfiguration** → `D3dxSkinManager/Modules/Migration/Steps/MigrationStep2MigrateConfiguration.cs`
- **MigrationStep3MigrateClassifications** → `D3dxSkinManager/Modules/Migration/Steps/MigrationStep3MigrateClassifications.cs`
- **MigrationStep4MigrateClassificationThumbnails** → `D3dxSkinManager/Modules/Migration/Steps/MigrationStep4MigrateClassificationThumbnails.cs`
- **MigrationStep5MigrateModArchives** → `D3dxSkinManager/Modules/Migration/Steps/MigrationStep5MigrateModArchives.cs:23`
...
- **MigrationStep6MigrateModPreviews** → `D3dxSkinManager/Modules/Migration/Steps/MigrationStep6MigrateModPreviews.cs`

#### Python Parsers

- **IPythonConfigurationParser** → `D3dxSkinManager/Modules/Migration/Parsers/PythonConfigurationParser.cs`
- **IPythonClassificationFileParser** → `D3dxSkinManager/Modules/Migration/Parsers/PythonClassificationFileParser.cs`
- **IPythonRedirectionFileParser** → `D3dxSkinManager/Modules/Migration/Parsers/PythonRedirectionFileParser.cs`
- **IPythonModIndexParser** → `D3dxSkinManager/Modules/Migration/Parsers/PythonModIndexParser.cs`

#### Migration Models

- **MigrationContext** → `D3dxSkinManager/Modules/Migration/Models/MigrationContext.cs`
- **MigrationOptions** → `D3dxSkinManager/Modules/Migration/Models/MigrationOptions.cs`
- **MigrationResult** → `D3dxSkinManager/Modules/Migration/Models/MigrationResult.cs`
- **MigrationProgress** → `D3dxSkinManager/Modules/Migration/Models/MigrationProgress.cs`
- **MigrationAnalysis** → `D3dxSkinManager/Modules/Migration/Models/MigrationAnalysis.cs`

#### Migration Documentation

- **Migration Architecture** → `docs/architecture/MIGRATION_ARCHITECTURE.md` ⭐ NEW (2026-02-20)
  - Complete migration system overview
  - Step-based architecture explanation
...
- **Migration Design** → `docs/migration/MIGRATION_DESIGN.md`
  - Original design document
- **Archived Refactoring Docs** → `docs/archive/2026-02-19-migration-refactoring/`
  - Historical analysis documents (outdated, kept for reference)
