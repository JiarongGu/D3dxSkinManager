...
| `remote-library.md` (token protection §) | Storing ANY credential/cookie/token at rest — protect via SecretProtector/DPAPI, never plaintext; store the session / keep auth safe on disk |
