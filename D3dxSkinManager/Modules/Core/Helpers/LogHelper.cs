...
// NOTE: `enum LogLevel` moved to the D3dxSkinManager.Plugin.Sdk assembly (same namespace) — plugins log
// via IPluginContext.Log(LogLevel, ...). ILogHelper (host-only) still uses it unchanged.
