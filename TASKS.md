...
- [ ] **[H]** `D3dxSkinManager/Modules/Mod/ModFacade.cs:308-315, 325-332, 350-357, 362-369` — Facade throws raw InvalidOperationException instead of OperationException for mod-not-found _(conf 95 · architecture)_
...
- [ ] **[H]** `D3dxSkinManager/Modules/Category/Services/CategoryService.cs:208-213` — Bare catch {} in UpdateParentAsync, BatchUpdateParentAsync, and DeleteAsync silently swallows all exceptions _(conf 100 · bug)_
...
- [ ] **[H]** `D3dxSkinManager.Client/src/shared/components/compact/CompactSpace.tsx:41-54` — vertical prop silently has no effect in non-compact mode _(conf 95 · bug)_
...
- [ ] **[H]** `D3dxSkinManager/Modules/Core/WebView/EmbeddedResourceProvider.cs:230-257` — Multi-dot filenames (Vite hashed chunks) map to wrong virtual paths _(conf 95 · bug)_
...
- [ ] **[H]** `D3dxSkinManager.Client/src/modules/mod/components/ModIniEditor/ModIniEditor.tsx:239-263` — Duplicate React keys from section.name — real .ini files have repeated section names _(conf 85 · bug)_
