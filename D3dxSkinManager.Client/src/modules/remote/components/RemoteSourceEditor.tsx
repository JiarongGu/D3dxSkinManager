...
export const RemoteSourceEditor: React.FC<RemoteSourceEditorProps> = ({ initial, origin, onCancel, onSaved }) => {
  ...
  const resolverTypeOptions = useMemo(
    () => [
      ...
      { value: 'kodbox', label: t('remote.resolverKodbox') },
      { value: 'quark', label: t('remote.resolverQuark') },
      { value: 'baidu', label: t('remote.resolverBaidu') },
      { value: 'mega', label: t('remote.resolverMega') },
