 ...
 *
 * This file documents the test scenarios for CategoryTree component.
...
// Mock data
const mockTreeData: CategoryInfo[] = [
  {
    id: 'cat1',
    name: 'Category 1',
    parentId: null,
...
const generateManyNodes = (count: number): CategoryInfo[] => {
 ...
 * 1. Load the app with 50+ Category nodes
 * 2. Verify scrollbar appears in the Category tree panel
...
describe('CategoryTree - Scrollbar Tests', () => {
 ...
 * Fix: Added explicit colors in CategoryTree.css lines 108-123
 *
 * Manual Testing Steps:
 * 1. Switch to light theme
 * 2. Click on a Category node
...
describe('CategoryTree - Theme Color Tests', () => {
  describe('CRITICAL: Light Theme Colors', () => {
    /**
     * Test 1: Verify light theme selection colors
     *
     * Location: CategoryTree.css lines 109-113
     * Expected:
     ...
     *
     * Location: CategoryTree.css lines 121-123
     ...
     *
     * Location: CategoryTree.css lines 115-118
  ...
  describe('Dark Theme Colors', () => {
     ...
     *
     * Location: CategoryTree.css lines 98-106
 ...
 * Fix: Added early return in CategoryTreeContext.tsx lines 216-220
 *
 * Manual Testing Steps:
 * 1. Select a Category folder node
 ...
 * --------------------------------------
 * These tests verify the fix for mod list flashing on first Category selection.
 *
 * Issue: When clicking a Category for the first time, all mods flashed briefly
 ...
 * Manual Testing Steps:
 * 1. Load app fresh
 * 2. Click a Category node for the first time
...
describe('CategoryTree - Flash Prevention Tests', () => {
  describe('CRITICAL: Prevent Flash on First Load', () => {
    /**
     * Test: First Category selection should not show all mods
     *
     * Location: ModHierarchicalView.tsx lines 82-89
     * Expected: Show empty array instead of state.mods while loading
     */
    test('should not show all mods when loading Category for first time', () => {
      // MANUAL TEST:
      // 1. Reload app
      // 2. Click a Category
      // 3. Watch mod list
...
describe('CategoryTree - Test Suite', () => {
